...
export default function Projects({ data }: { data: { [key: string]: any }[] }) {
      ...
      <Grid item xs={12} lg={6}>
        ...
        <Hidden mdDown>
          <Fade in={animate} style={{ transitionDelay: "250ms" }}>
            <div>
              <Image alt="Projects" src="/projects.svg" width="575" height="325" />
            </div>
          </Fade>
        </Hidden>
      </Grid>
            ...
            <Grid item sm={6} xs={12} key={i}>
              <Fade in={animate} style={{ transitionDelay: `${200 * i}ms` }}>
                <Card key={i} className={classes.card}>
                  <CardActionArea className={classes.cardActionArea} href={v.value.html_url} target="_blank" rel="noopener noreferrer">
                    <CardHeader
                      title={
                        <>
